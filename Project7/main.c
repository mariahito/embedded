...
void main(void)
{
    volatile unsigned char TestNumber;
    volatile unsigned char NumberOfTestsPassed;
    ...
    volatile unsigned char TestHasNotFailed[NUMBER_OF_TESTS];
        ...
        LFSR_TYPE* LFSRStateAfterWrite)
{
    ...
    if (EraseMode == CHIP_ERASE) {
        ...
        // Erase the remaing half using block-erase.
